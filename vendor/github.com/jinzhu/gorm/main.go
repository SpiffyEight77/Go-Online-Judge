...
// Pluck used to query single column from a models as a map
//     var ages []int64
...
// Count get how many records for a models
...
// SetJoinTableHandler set a models's join table handler for a relation
